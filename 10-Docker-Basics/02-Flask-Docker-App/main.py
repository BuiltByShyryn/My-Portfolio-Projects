...
@app.route("/")
def home():
    return navbar + "<h1>Hello, World!</h1>"

@app.route("/about")
def about():
    return navbar + "<h1>About page</h1>" 
...
def contact():
    ...
    <h1>Contacts page:</h1>
    <ul>
        <li>First number: 123-456-7890</li>
        <li>Second number: 123-456-7890</li>
        <li>Third number: 123-456-7890</li>
    </ul>
    """ 
...
def datetime_page():
    ...
    return navbar + f"<h1>Current Time: {now}</h1>" 
