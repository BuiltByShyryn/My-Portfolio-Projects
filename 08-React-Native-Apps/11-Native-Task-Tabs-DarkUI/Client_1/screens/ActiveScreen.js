...
export default function ActiveScreen({ todos, compledtedTaskHandler, addTodoHandler }) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.wrapper}>
                ...
                <TouchableOpacity style={styles.input_btn} onPress={submitHandler}>
                    <Ionicons name="add-outline" color="#fff" size={28} />
                </TouchableOpacity>
            </View>
                ...
                renderItem={({ item }) => (
                    <View style={styles.todo_item}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => compledtedTaskHandler(item.id)}
                        >
                            <Ionicons name="checkbox-outline" size={22} color="#005826" />
                        </TouchableOpacity>
                    </View>
                )}
            />
